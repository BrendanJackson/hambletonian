...
class LinkedRetail_LiquidPixels_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option
{
    protected $_product;
    ...
    {
        parent::__construct();
        $this->setTemplate('liquidpixels/catalog/product/edit/options/option.phtml');
...
//        $optionsArr = $this->getProduct()->getOptions();
        ...
        if (!$this->_values) {
            ...
            foreach ($optionsArr as $option) {
                ...
                $value['liquifire_argument'] = $option->getLiquifireArgument();
